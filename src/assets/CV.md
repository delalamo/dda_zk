...
* Familiarity with generative AI methods for sequence- and structure-based protein and antibody design (RFdiffusion, Progen, ESM, AbLang, inverse folding methods such as LigandMPNN, etc)
* Structural modeling with Rosetta (10 years of experience), as well as Boltz-2, AlphaFold2, and ESMFold, including modifying source code
* Modeling small molecules (MOE) and molecular dynamics simulations (OpenMM, Maestro)

**Bioinformatics and deep learning**
* Sequence and structural search, alignment, and clustering (HMMer, Foldseek, TM-align, MMseqs)
* Designing pipelines with Nextflow and containerization with Docker and Singularity
* Training, fine-tuning, and transfer learning for generative and predictive modeling (PyTorch)

**Programming skills**
* Python (8 years of experience; NumPy, PyTorch, Pandas, SKLearn, Huggingface), R (ggplot2)

**Miscellaneous skills**
* Experience making high-quality figures using Inkscape, GIMP, and PyMOL. Comfortable with LaTeX
...
### GSK (Cambridge, MA, USA, & Baar, ZG, Switzerland)
**Principal Scientist - Protein Design & Informatics (May 2022 - Oct 2025)**
...
* Identifying starting points for directed evolution campaigns using bioinformatics search tools (HMMer and MMSeqs, Foldseek), structural modeling (MOE), and ligand-binding pocket featurization
...
* Initiated and led a multi-departmental project focused on designing and testing transformer- and CNN-based AI/ML methods written in PyTorch for processing spectroscopy data
...
*My PhD research focused on the transporter GadC using experiments and computation. This interdisciplinary project involved spectroscopy measurements, activity assays, and integrative modeling of membrane proteins with custom-written C++ and Python code using experimental data as geometric restraints*
* Supervised and mentored undergraduates, Master's students, research assistants, and Ph.D. rotation students
...
**Major:** Biochemistry, Cellular, and Molecular Biology (Aug 2008 - May 2012)
